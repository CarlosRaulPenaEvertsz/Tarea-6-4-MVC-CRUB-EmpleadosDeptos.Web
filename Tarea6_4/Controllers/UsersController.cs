...
namespace Tarea6_4.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdUser,Name,LastName,UserName,Password,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdUser,Name,LastName,UserName,Password,Email")] User user)
        {
            if (ModelState.IsValid)
            {
